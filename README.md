...
* This can be done directly in VSCode
  ...
  * For this assignment I'll create an environment named Advanced with package ipykernel (allows us to use the new environment with Jupyter Notebook) with command `conda create --name Advanced ipykernel`
  ...
  * We'll be doing this assignment in a Jupyter Notebook in Anaconda or VSCode. Activate your new environment by running the command `source activate Advanced`. Add the kernel for your new environment to Jupyter Notebook by running the command `python -m ipykernel install --user --name=Advanced`.
...
* Complete the Advanced Tutorials section at: https://www.learnpython.org/
  ...
  * If you enter help(), you can type quit to exit.
...
* To remove the environment from your Jupyter Notebooks run the code `jupyter kernelspec uninstall Advanced`.
* Get a list of the environments in Conda run `conda env list`.
* To delete an environment and everything in it run `conda env remove --name Advanced`.
